...
exports.assertCompletion = function(text, angularTypes, expression, scope, expected, substraction, options, name) {
  var defs = [];
...
exports.assertOutline = function (text, expected, substraction, options) {
  var defs = []
  var defNames = ['browser']
  if (defNames) {
    for (var i = 0; i < defNames.length; i++) {
